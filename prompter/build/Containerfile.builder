# Builder image for the prompter project. All builds, tests, and lints run
# here. No Go is required on the host.
#
...
# All tools are built from source against our pinned Go toolchain. Building
# golangci-lint from source avoids "binary built with go1.X < project go1.Y"
# mismatches when a new Go release lands.
