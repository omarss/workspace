"""Tests for the Slack bot database layer."""
...
def test_get_or_create_user_creates():
    user_id = get_or_create_user("U123ABC", display_name="Test")
    assert user_id == "U123ABC"


def test_get_or_create_user_idempotent():
    uid1 = get_or_create_user("U123ABC", username="testuser")
    uid2 = get_or_create_user("U123ABC", username="updated")
    assert uid1 == uid2 == "U123ABC"
...
def test_save_and_get_question():
    ...
    from swet_slack.db import get_user_question
...
def test_user_isolation():
    ...
    user1 = get_or_create_user("U001")
    user2 = get_or_create_user("U002")
