"""User-scoped adaptive algorithm wrappers for the Telegram bot.
...
import swet_telegram.db as telegram_db
...
def _db(user_id: str) -> AdaptiveDB:
    """Create a user-scoped DB adapter for the Telegram database."""
    return UserScopedDB(user_id, telegram_db)
