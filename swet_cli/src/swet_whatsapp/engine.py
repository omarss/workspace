"""User-scoped adaptive algorithm wrappers for the WhatsApp bot.
...
import swet_whatsapp.db as whatsapp_db
...
def _db(user_id: str) -> AdaptiveDB:
    """Create a user-scoped DB adapter for the WhatsApp database."""
    return UserScopedDB(user_id, whatsapp_db)
