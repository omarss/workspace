...
INSERT INTO job_postings (
    ...
    employment_type, work_arrangement, experience_level,
    raw_location, city_id, region_code, country_code, office_address,
...
VALUES (
    ...
    %(raw_location)s, %(city_id)s, %(region_code)s, %(country_code)s, %(office_address)s,
...
UPDATE job_postings SET
    ...
    region_code             = COALESCE(%(region_code)s, region_code),
...
def _insert_params(
    ...
    return {
        ...
        "region_code": posting.region_code,
